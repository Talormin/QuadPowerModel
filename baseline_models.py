...
This module only defines models and recommended default configurations. Importing
the module does not load data, train models, create figures, or write results.
